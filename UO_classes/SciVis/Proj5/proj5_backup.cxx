    ...
    for (int x = 0; x < dims[0]-1; x++) {
        for (int y = 0; y < dims[1]-1; y++) {
            ...
            for(int i = 0; i < nsegments; i++){
                ...
                if (edge1 == 0){
                    pt1[0] = ((isovalue-f0)/(f1-f0))*(pt2_x-pt0_x) + pt0_x;
                    pt1[1] = pt0_y;
                }
                else if (edge1 == 2){
                    pt1[0] = ((isovalue-f2)/(f3-f2))*(pt3_x-pt2_x) + pt2_x;
                    pt1[1] = pt2_y;
                }
                else if (edge1 == 1){
                    pt1[0] = pt1_x;
                    pt1[1] = ((isovalue-f1)/(f2-f1))*(pt2_y-pt1_y) + pt1_y;
                }
                else if (edge1 == 3){
                    pt1[0] = pt3_x;
                    pt1[1] = ((isovalue-f0)/(f3-f0))*(pt3_y-pt0_y)+pt0_y;
                }

                int edge2 = lup[icase][2*i+1];
                if (edge2 == 0){
                    pt2[0] = ((isovalue-f0)/(f1-f0))*(pt1_x-pt0_x)+pt0_x;
                    pt2[1] = pt0_y;
                }
                else if (edge2 == 2){
                    pt2[0] = ((isovalue-f2)/(f3-f2))*(pt3_x-pt2_x)+pt2_x;
                    pt2[1] = pt2_y;
                }
                else if (edge2 == 1){
                    pt2[0] = pt1_x;
                    pt2[1] = ((isovalue-f1)/(f2-f1))*(pt2_y-pt1_y)+pt1_y;
                }
                else if (edge2 == 3){
                    pt2[0] = pt0_x;
                    pt2[1] = ((isovalue-f0)/(f3-f0))*(pt3_y-pt0_y)+pt0_y;
                }
